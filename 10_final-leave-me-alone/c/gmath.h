...
// extern struct hash_entry *lighting_hash;
//
// void add_light(struct hash_entry *s) {
//     HASH_ADD_INT( lighting_hash, id, s );
// }
//
// void add_vertex_normal(double * normal, double * view);
