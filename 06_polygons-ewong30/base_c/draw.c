...
void add_box( struct matrix * edges,
  ...
  //front
  add_polygon(edges, x1, y1, z0, x1, y0, z0, x0, y0, z0);//face 1 (front)
  add_polygon(edges, x1, y1, z0, x0, y0, z0, x0, y1, z0);//face 1 (front)

  //sides
  add_polygon(edges, x0, y1, z0, x0, y0, z1, x0, y1, z1); //face 2 (left)
  add_polygon(edges, x0, y1, z0, x0, y0, z0, x0, y0, z1);//face 2 (left)

  add_polygon(edges, x0, y1, z1, x0, y0, z1, x1, y0, z1);//face 3 (back)
  add_polygon(edges, x0, y1, z1, x1, y1, z1, x1, y0, z1);//face 3 (back)


  add_polygon(edges, x1, y0, z1, x1, y1, z0, x1, y1, z1);//face 4 (right)
  add_polygon(edges, x1, y0, z1, x1, y0, z0, x1, y1, z0);//face 4 (right)

  //things
  add_polygon(edges, x0, y0, z0, x1, y0, z1, x0, y0, z1); //top
  add_polygon(edges, x1, y0, z0, x1, y0, z1, x0, y0, z0); //top

  add_polygon(edges, x1, y1, z0, x1, y1, z1, x0, y1, z0); //bottom
  add_polygon(edges, x0, y1, z0, x1, y1, z1, x0, y1, z1); //bottom
}
