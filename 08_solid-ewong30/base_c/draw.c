...
void scanline_convert( struct matrix *points, int i, screen s, zbuffer zb ) {
  ...
  double x0, x1, y0, y1, y2, dx0, dx1;
  int flip = 0;

  double z0, z1, dz0, dz1 = 0;
 ...
 c.blue = (215 * (i/3))%255;
  ...
  // double **m = points->m;
  // double xB, xT, xM, yB, yT, yM, dx0, dx1, x0, x1, zB, zM, zT, z0, z1;
  // int bot, mid, top, pTemp, z1;
  // double yTemp, xTemp;
  //
  // yB = m[1][i];
  // yM = m[1][i + 1];
  ...
  //   }
  //
  //   draw_scanline(x0, z0, x1, z1, i, s, zb, c);
  // }
}
